...
|---|---|---|---|---|---|---|---|
| Tool use (function calling) | [yes](langgraph.md#tools) | [yes](langchain.md#tools) | [yes](pydantic-ai.md#tools) | [yes](crewai.md#tools) | [yes](claude-agent-sdk.md#tools) | [yes](mastra.md#tools) | [yes](vercel-ai-sdk.md#tools) |
| Structured output (Pydantic / Zod) | [integration](langgraph.md#structured-output) | [yes](langchain.md#structured-output) | [yes](pydantic-ai.md#structured-output) | [partial](crewai.md#structured-output) | [partial](claude-agent-sdk.md#tools) | [yes](mastra.md#structured-output) | [yes](vercel-ai-sdk.md#structured-output) |
| Memory / message history | [yes](langgraph.md#memory) | [yes](langchain.md#memory) | [partial](pydantic-ai.md#memory) | [yes](crewai.md#memory) | [partial](claude-agent-sdk.md#mental-model) | [yes](mastra.md#memory) | [partial](vercel-ai-sdk.md#memory) |
| Checkpointing / state persistence | [yes](langgraph.md#memory) | [no](langchain.md#anti-patterns) | [no](pydantic-ai.md#anti-patterns) | [partial](crewai.md#memory) | [yes](claude-agent-sdk.md#mental-model) | [yes](mastra.md#memory) | [no](vercel-ai-sdk.md#anti-patterns) |
| Streaming (tokens) | [yes](langgraph.md#streaming) | [yes](langchain.md#streaming) | [yes](pydantic-ai.md#streaming) | [partial](crewai.md#streaming) | [yes](claude-agent-sdk.md#minimal-python-agent) | [yes](mastra.md#streaming) | [yes](vercel-ai-sdk.md#streaming) |
| Streaming (tool calls) | [yes](langgraph.md#streaming) | [yes](langchain.md#streaming) | [yes](pydantic-ai.md#streaming) | [partial](crewai.md#streaming) | [yes](claude-agent-sdk.md#minimal-python-agent) | [yes](mastra.md#streaming) | [yes](vercel-ai-sdk.md#streaming) |
| Multi-agent orchestration | [yes](langgraph.md#composition-matrix) | [no](langchain.md#anti-patterns) | [no](pydantic-ai.md#anti-patterns) | [yes](crewai.md#composition-matrix) | [yes](claude-agent-sdk.md#subagents) | [yes](mastra.md#composition-matrix) | [no](vercel-ai-sdk.md#anti-patterns) |
| Async / concurrency | [yes](langgraph.md#when-to-choose-langgraph) | [yes](langchain.md#tools) | [yes](pydantic-ai.md#when-to-choose-pydantic-ai) | [yes](crewai.md#when-to-choose-crewai) | [yes](claude-agent-sdk.md#tools) | [yes](mastra.md#when-to-choose-mastra) | [yes](vercel-ai-sdk.md#when-to-choose-vercel-ai-sdk) |
| Sync API | [yes](langgraph.md#when-to-choose-langgraph) | [yes](langchain.md#minimal-agent) | [yes](pydantic-ai.md#minimal-agent) | [yes](crewai.md#when-to-choose-crewai) | [partial](claude-agent-sdk.md#minimal-python-agent) | [no](mastra.md#anti-patterns) | [no](vercel-ai-sdk.md#anti-patterns) |
| Built-in observability | [partial](langgraph.md#observability) | [yes](langchain.md#observability) | [yes](pydantic-ai.md#observability) | [partial](crewai.md#observability) | [partial](claude-agent-sdk.md#observability) | [partial](mastra.md#observability) | [no](vercel-ai-sdk.md#observability) |
| Built-in retries / backoff | [no](langgraph.md#anti-patterns) | [yes](langchain.md#tools) | [no](pydantic-ai.md#anti-patterns) | [partial](crewai.md#when-to-choose-crewai) | [no](claude-agent-sdk.md#anti-patterns) | [yes](mastra.md#when-to-choose-mastra) | [no](vercel-ai-sdk.md#anti-patterns) |
| MCP support | [integration](langgraph.md#composition-matrix) | [integration](langchain.md#tools) | [integration](pydantic-ai.md#anti-patterns) | [no](crewai.md#anti-patterns) | [yes](claude-agent-sdk.md#mcp-server-hosting-and-consumption) | [yes](mastra.md#when-to-choose-mastra) | [no](vercel-ai-sdk.md#anti-patterns) |
| First-class TypeScript | [partial](langgraph.md#anti-patterns) | [partial](langchain.md#composition-matrix) | [no](pydantic-ai.md#anti-patterns) | [no](crewai.md#anti-patterns) | [yes](claude-agent-sdk-typescript.md) | [yes](mastra.md#when-to-choose-mastra) | [yes](vercel-ai-sdk.md#when-to-choose-vercel-ai-sdk) |
