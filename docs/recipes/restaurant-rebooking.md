...
- `docs/cross-cutting/security-hardening.md` · `docs/cross-cutting/authorization-rbac.md` · `docs/cross-cutting/audit-logging.md` · `docs/cross-cutting/pii-gdpr.md` · `docs/cross-cutting/cost-tracking.md`
