...
load_list:
  - {path: https://github.com/jagguvarma15/agent-blueprints/blob/main/patterns/event_driven/overview.md, required: true}
...
- `https://github.com/jagguvarma15/agent-blueprints/blob/main/patterns/event_driven/overview.md` — the event-driven agent pattern
- `https://github.com/jagguvarma15/agent-blueprints/blob/main/patterns/multi_agent/overview.md` — the multi-agent flat composition
