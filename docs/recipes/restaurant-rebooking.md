...
- Cross-cutting: [Logging](../cross-cutting/logging-structured.md), [Observability](../cross-cutting/observability.md), [Testing strategy](../cross-cutting/testing-strategy.md), [Idempotency](../cross-cutting/idempotency.md), [Resilience](../cross-cutting/resilience.md), [Health & graceful shutdown](../cross-cutting/health-graceful-shutdown.md)
