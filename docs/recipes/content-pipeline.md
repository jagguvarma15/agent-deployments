...
topology: chain
load_list:
  - {path: ../../vendored/blueprints/patterns/prompt-chaining/overview.md, required: true}
...
- Pattern: [Prompt Chaining](../../vendored/blueprints/patterns/prompt-chaining/overview.md)
...
- `vendored/blueprints/patterns/prompt-chaining/overview.md` — the prompt chaining pattern
