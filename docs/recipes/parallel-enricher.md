...
topology: parallel
load_list:
  - {path: https://github.com/jagguvarma15/agent-blueprints/blob/main/patterns/parallel-calls/overview.md, required: true}
...
- Pattern: [Parallel Calls](https://github.com/jagguvarma15/agent-blueprints/blob/main/patterns/parallel-calls/overview.md)
...
- `https://github.com/jagguvarma15/agent-blueprints/blob/main/patterns/parallel-calls/overview.md` — the parallel calls pattern
